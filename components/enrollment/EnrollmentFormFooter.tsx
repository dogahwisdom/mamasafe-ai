  ...
  <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10 bg-gradient-to-t from-white via-white to-transparent dark:from-[#1c1c1e] dark:via-[#1c1c1e] pt-12 flex justify-between items-center z-20">
    ...
    {step < 5 ? (
      <button
        type="button"
        onClick={onNext}
        className="group flex items-center gap-2 px-6 md:px-8 py-3 md:py-4 bg-slate-900 dark:bg-white text-white dark:text-black rounded-full font-bold hover:scale-105 active:scale-95 transition-all shadow-xl text-sm md:text-base"
      >
      ...
      <button
        ...
        className={`group flex items-center gap-2 px-6 md:px-8 py-3 md:py-4 rounded-full font-bold transition-all shadow-lg text-sm md:text-base ${
          consent
